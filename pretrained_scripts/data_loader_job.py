...
def load_datasets(csv_path, batch_size=32, use_pretrained=True):
    ...
    # Use at most the number of CPU cores available, and respect the system suggestion of 1
    num_workers = min(1, multiprocessing.cpu_count())
    
    # Create dataloaders with appropriate worker count
